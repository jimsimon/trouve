# ADR 0057: Review UI on the desktop design system

Status: Accepted (2026-09)

Amends ADR 0056 (the shared review UI keeps its own look and stylesheet).

## Context

ADR 0056 unified the review dashboard and the desktop on one Lit codebase but
...
ADR 0056 are no longer the reference. Because the dashboard is drawn from
