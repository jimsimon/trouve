# ADR 0051: Cursor shared-store transition and callback quarantine

Status: Accepted (2026-08)

Extends [ADR 0050](0050-shared-cursor-sdk-bridge-process.md). Its one-Bridge-
per-backend ownership and exact-agent callback routing remain in force.

## Context

Before ADR 0050, each Cursor thread hashed its provider and thread ids into a
