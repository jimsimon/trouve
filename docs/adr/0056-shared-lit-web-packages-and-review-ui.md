# ADR 0056: Shared Lit web packages and review UI

Status: Accepted (2026-09), amended by ADR 0057 (the shared review UI is drawn
...
quality for free where it adopts the shared packages (ADR 0057 does so for
