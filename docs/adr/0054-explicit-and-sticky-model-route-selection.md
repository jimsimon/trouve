# 0054 — Explicit and sticky model route selection

Status: Accepted (2026-08).

## Context

ADR 0053 introduced provider-neutral model selection and bounded failover, but
...
This decision partially supersedes ADR 0053's picker-identifier and
