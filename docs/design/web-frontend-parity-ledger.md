...
hardening evidence above. ADR 0028 makes Wry/Lit the sole shipping desktop
frontend, and ADR 0039 makes the retained Servo evidence historical rather than
an active promotion gate.
...
- Global defaults, built-in/custom personas, create/edit/delete/reset flows,
  inherited settings, and model selections are exposed in Lit settings.
- Persona data remains protocol-driven rather than introducing persona-specific
