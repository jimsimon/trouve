...
import { highlightSourceOffThread } from "@trouve-ai/content-rendering/content-worker-client";
import type { HighlightToken } from "@trouve-ai/content-rendering/content-worker-protocol";
import { parseUnifiedDiff } from "@trouve-ai/content-rendering/diff-parser";
import { languageForPath } from "@trouve-ai/content-rendering/file-language";
import "@trouve-ai/content-rendering/markdown-view";
import {
  presentToolDetail,
