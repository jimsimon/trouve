import type { components as ProtocolComponents } from "@trouve-ai/protocol/types";
import type {
  ThreadChatItem,
  TurnState,
} from "./thread-view-model.js";
import { isVideoMime } from "./attachments.js";
import { utf8Length, utf8Prefix } from "@trouve-ai/protocol/utf8-text";
