import {
  createSignal,
  type ReadonlySignal,
} from "@trouve-ai/ui-foundation/reactivity";
...
/** Whether two preference sets group a transcript identically. */
export const sameChatCollapsePreferences = (
  left: ChatPreferences,
  right: ChatPreferences,
): boolean =>
