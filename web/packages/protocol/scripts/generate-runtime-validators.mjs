...
} from "./runtime-validators.mjs";

const packageRoot = new URL("../", import.meta.url);
const { checkOnly } = parseGeneratorArguments();

const protocolSchemaId = "urn:trouve:protocol-openapi";
const protocolDocument = readJson(new URL("src/generated/protocol-openapi.json", packageRoot));
...
const protocolValidators = {
  ...
  generatedTitle: componentRef(protocolSchemaId, "GeneratedTitle"),
  summaries: componentRef(protocolSchemaId, "SessionSummariesSnapshot"),
  workspace: componentRef(protocolSchemaId, "WorkspaceListItem"),
  workspaces: componentArray(protocolSchemaId, "WorkspaceListItem"),
  ...
  sessionNamingSettings: componentRef(protocolSchemaId, "SessionNamingSettings"),
...
writeGeneratedModules({
  ...
  packageRoot,
  checkOnly,
  regenerateCommand: "npm run generate:validators --workspace @trouve-ai/protocol",
});
