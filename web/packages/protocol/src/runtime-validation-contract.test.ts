...
describe("CSP-safe runtime validation", () => {
  it("keeps generated validators synchronized with the OpenAPI snapshot", () => {
  ...
  it("does not compile schemas or evaluate source in the runtime client", () => {
    const source = read("./protocol-client.ts");
  ...
  it("emits standalone ESM without CSP-hostile runtime helpers", () => {
    for (const relativePath of [
      ...
      "./generated/thread-view-validator.ts",
    ]) {
