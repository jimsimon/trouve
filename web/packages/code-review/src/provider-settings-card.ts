...
export class ProviderSettings extends ReviewElement {
  ...
  private async saveDefaults(event: Event): Promise<void> {
    ...
    const selectedModel = modelForSelection(this.models, this.defaultModel);
  ...
  protected override render(): TemplateResult {
    ...
    const selectedModel = modelForSelection(models, this.defaultModel);
    const defaultThinkingOptions = thinkingOptions(selectedModel);
      ...
      <form @submit=${(event: Event) => void this.saveDefaults(event)}>
        <label>
          ...
          <select
            ...
            required
          >
            ${modelChoices(models, this.defaultModel)}
            ${selectValue(modelSelectionValue(models, this.defaultModel))}
          </select>
        ...
        <button type="submit" ?disabled=${!modelsLoaded || !this.defaultModel}>
