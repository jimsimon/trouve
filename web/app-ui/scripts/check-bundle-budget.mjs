...
// The locked Vite/Rolldown graph emits 3,130,380 B after the thread-runtime,
// tool-detail, and provider-recovery additions. Keep less than 4 kB of
...
const totalJavaScriptLimit = 3_134_000;
