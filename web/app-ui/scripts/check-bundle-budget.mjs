...
// The locked Vite/Rolldown graph emits 3,198,295 B after the evidence-backed
...
// per-thread transcript-search, detailed agent-activity, and default-branch
// metadata additions. Keep less than 2 kB of headroom;
