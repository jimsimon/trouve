...
// The locked Vite/Rolldown graph emits 3,177,133 B after the evidence-backed
// review-history, churn-metrics, durable turn-phase, conditional-title, and
// version-check UI additions. Keep about 5 kB of headroom above that artifact;
// entry, worker, and largest-chunk budgets below still prevent one bundle from
// hiding in the aggregate.
const totalJavaScriptLimit = 3_182_000;
