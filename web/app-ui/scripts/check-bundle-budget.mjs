...
// schemas bring them to 3,302,298 B and 3,287,443 B; preserve less than
// 2 kB of headroom for each. Entry, worker, and largest-chunk budgets
// below still prevent one bundle from hiding in the aggregate.
const totalJavaScriptLimit = mode === "desktop" ? 3_304_000 : 3_289_000;
