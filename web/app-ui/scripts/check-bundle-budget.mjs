...
// The locked Vite/Rolldown graph emits 3,198,008 B after the evidence-backed
...
// per-thread transcript-search, detailed agent-activity, and native web-search
// presentation additions. Keep less than 2 kB of headroom; entry, worker, and
// largest-chunk budgets below continue to prevent one bundle from hiding in
// the aggregate.
const totalJavaScriptLimit = 3_200_000;
