...
export class TrouveApp extends withSignalTracking(LitElement) {
  ...
  #resetNewSessionOptionsForWorkspace(workspaceId: string): void {
    ...
    if (this.#newSessionOptionsWorkspaceId !== workspaceId) {
          ...
          <form @submit=${this.#createSession}>
            <header>
              <div>
                ...
                <p>Pick where to work, what to branch from, and how the agent should run.</p>
              </div>
            </header>
            ...
            <label class="dialog-checkbox">
              <input name="fetch_latest" type="checkbox" checked ?disabled=${this.#newSessionPending} />
