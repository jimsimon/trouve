import type { ThreadChatItem } from "@trouve-ai/transcript/thread-view-model";
import { TOOL_OUTPUT_OMITTED_MESSAGE } from "@trouve-ai/transcript/tool-output";
import { buildChatLayout } from "@trouve-ai/transcript/chat-layout";
import {
