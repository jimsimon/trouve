...
import type { CursorEventStream } from "@trouve-ai/protocol/event-stream";
import {
  ThreadIngress,
  ThreadReplayBatcher,
  type ThreadProtocol,
...
import { ThreadViewModel } from "@trouve-ai/transcript/thread-view-model";
...
describe("ThreadReplayBatcher projection parity", () => {
  const envelope = (
    cursor: number,
