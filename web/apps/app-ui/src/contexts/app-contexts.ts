...
import type { ProtocolClient } from "@trouve-ai/protocol/client";
import type { PendingAttachment } from "@trouve-ai/transcript/attachments";
import type {
  HostCloseDecision,
  HostLifecycleBatch,
  HostLocalFileAction,
...
import type { ReadonlySignal } from "@trouve-ai/ui-foundation/reactivity";
