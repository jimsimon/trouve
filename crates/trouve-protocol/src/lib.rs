...
// 1.19: provider-neutral command and skill catalogs, typed prompt/action
// commands, command execution events and endpoints, and configurable built-in
// skill enablement (all additive).
