...
impl Controller {
    ...
    async fn fix_pr_review(
        ...
        // provisional form's model-specific options into that thread.
        self.new_chat_model_options.clear();
        self.start_new_chat(
            NewChatSelection {
                workspace_idx,
...
mod tests {
    use super::{
        ChatWindow, ModelOptionInput, ModelOptionKind, ModelOptionScalar, ServerReplayBuffer,
        SubscriptionRefresh, SubscriptionRefreshState, apply_model_option_input, approval_pill,
