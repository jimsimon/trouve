...
use trouve_protocol::{
    ...
    CreateTeamRequest, CreateThreadRequest, DirEntry, EventEnvelope, ModelInfo, PermissionMode,
    Session, SessionKind, TeamStatus, Thread, TodoStatus, UpdateSessionRequest,
                ...
                if selection.team {
                    ...
                    let created = self
                        ...
                        .create_team(&CreateTeamRequest {
                            ...
                            title: Some(session_title_fallback(&prompt)),
...
mod tests {
    ...
    use trouve_protocol::{
        ...
        SessionKind, SubscriptionHealth, SubscriptionWindow, Workspace,
    };
