...
use trouve_protocol::{
    ...
    CreateThreadRequest, DirEntry, EventEnvelope, PermissionMode, RoutedModelInfo, Session, Thread,
    ...
    async fn refresh_settings(&mut self) {
        ...
        ui::set_settings_data(
            ...
            ui::ProviderSettingsView {
                ...
                known: known.clone(),
                provider_order: providers.provider_order.clone(),
            },
            model_ids.clone(),
            thinking_views,
            default_index,
...
mod tests {
    ...
    use trouve_protocol::{
        CheckRun, Event, EventEnvelope, GithubPrList, PrInfo, PrReview, RoutedModelInfo, Scope,
